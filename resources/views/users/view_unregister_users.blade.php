	    ...
	    <tr>
	        ...
	        <td class="text-center">
                <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                    ...
                    @can('user-edit')
                    <a class="btn btn-info btn-sm" href="{{ route('users.edit', $user->id) }}" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}"><i class="fas fa-edit"></i> Edit</a>
                    @endcan

                    @csrf
                    @method('DELETE')
                    @can('user-delete')
                    <a href="{{ route('users.destroy', $user->id) }}" class="btn btn-danger btn-sm" data-confirm-delete="true"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                    @endcan
                </form>
	        </td>
	    </tr>
                    ...
                    <div class="form-group">
                      <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                          ...
                          <img src="{{ asset('esignature_image/' . $user->esignature_filename ) }}" width="50px;" height="100px;" alt="eSignature Image">
                          @endif
                        </div>
