...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-5">
        <div class="col-sm-6">
          <h1 class="m-0">Pre Travel Order</h1>
        </div><!-- /.col -->
...
<div class="row m-2">
    <form action="{{ route('travel.store') }}" method="POST" id="add-form" enctype="multipart/form-data">
        @csrf
    ...
    <div class="row mx-5">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              {{-- <div class="itineryMain" id="itinerary-form">
                <div class="mb-3 row itineraryField" id="itinerary_field">
                  <div class="col-2">
        ...
        <div class="mt-4 text-center">  
          ...
          {{-- <button type="button" class="btn btn-primary" id="formSubmit" data-bs-toggle="modal" data-bs-target="#previewCreateTravel">Preview</button> --}}
